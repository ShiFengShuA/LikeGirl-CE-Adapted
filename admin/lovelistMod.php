    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                ...
                <form class="needs-validation" action="lovelistUpdaPost.php" method="post" onsubmit="return check()" novalidate>
                    ...
                    <div class="form-group mb-3" id="img_url"
                        ...
                        <div class="d-flex align-items-center">
                            <input class="form-control flex-fill mr-2" type="text" id="validationCustom01" name="imgUrl" placeholder="请输入图片地址 (没有则无需填写)" value="<?php echo $imgUrl ?>">
